      ...
      <Container>
        <div className="w-full pt-6">
          <p className="mb-14 py-1 text-left border-l-4 border-blue-500 pl-8 text-base text-gray-600 font-medium leading-8">
            Avid Prepaid Visa Debit card allows you to get your federal benefits up to 6 days early and all other direct deposits up to 2 days early.
            <sup>1</sup> It's digital banking at its best! With no overdraft fees or minimum balance requirement,<sup>2</sup> you always have control over your account. Getting started is easy, just enter your mobile number and click "Let's Get Started" to sign up today!
          </p>
        </div>
      </Container>
      <Container>
        <div
          className="landing-about grid grid-cols-1 md:grid-cols-2 bg-white rounded-3xl overflow-hidden"
        >
          ...
          <div className="py-8 pt-0 md:pt-8 pl-8 md:pl-0 pr-10">
            ...
            <h3
              className="text-gray-600 mt-2 mb-5 font-medium md:text-2xl text-xl"
            >
            ...
            <a
              href="#faq"
              className="btn btn-large bg-blue-500 text-white"
            >
              Learn More
            </a>
          </div>
